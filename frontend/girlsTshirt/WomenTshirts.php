...
<head>
    ...
    <title> Women | T-shirts | MauriShop</title>
            ...
            <div class="col" style="height: 33rem;">
                    ...
                    <div class="card" style="width: 18rem;">
                        ...
                        <div class="card-body" style="height: 13rem;">
                            <form name="form" action="../../backend/WomenTshirt/addtocart.php?id=<?php echo $item_id?>&pric=<?php echo $price?>" method="post">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <button type="button" class="btn btn-outline-success"
                                                        ...
                                                        data-bs-target="#<?php echo $givereviewid?>"
